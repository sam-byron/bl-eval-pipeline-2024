...
if not os.path.exists("evaluation_data/ewok_filtered"):
    os.mkdir("evaluation_data/ewok_filtered/")
...
for domain in items_per_domain.keys():
    with open(f"evaluation_data/ewok_filtered/{domain}.jsonl", 'w') as outfile:
